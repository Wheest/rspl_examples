...
int main() {
  ...
  printf("Check stderr for DMEM contents.\n");

  uint8_t dmem[4096];           // Contents of DMEM
  rsp_read_data(dmem, 4096, 0); // Read DMEM

  fprintf(stderr, "DMEM contents:\n");
  debug_hexdump(dmem, 4096);
